...
import com.driverprofit.core.ui.format.BackupLabels
...
fun BackupScreen(
    ...
    viewModel: BackupViewModel = viewModel(factory = DriverProfitViewModelFactory.Factory),
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    val suggestedName = remember {
        "driver-profit-${LocalDate.now().format(DateTimeFormatter.ISO_LOCAL_DATE)}.backup"
    }
