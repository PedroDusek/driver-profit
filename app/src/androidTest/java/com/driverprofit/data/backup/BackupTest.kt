package com.driverprofit.data.backup
 ...
 * (`context.getDatabasePath(DriverProfitDatabase.NAME)`), como
...
class BackupTest {
    ...
    fun createDatabase() {
        ...
        dbFile = context.getDatabasePath(DriverProfitDatabase.NAME)
        deleteDatabaseFiles()
        database = Room.databaseBuilder(context, DriverProfitDatabase::class.java, DriverProfitDatabase.NAME)
    ...
    fun importaArquivoDeVersaoMaisNovaERejeitadoSemTocarNoBancoVivo() = runTest {
        ...
        SQLiteDatabase.openOrCreateDatabase(futureFile, null).use { db ->
            ...
            db.version = DriverProfitDatabase.VERSION + 1
        }
    ...
    fun importaBackupValidoTrocaOArquivoNoDisco() = runTest {
        ...
        val reopened = Room.databaseBuilder(context, DriverProfitDatabase::class.java, DriverProfitDatabase.NAME)
            .addMigrations(*Migrations.ALL)
            .build()
